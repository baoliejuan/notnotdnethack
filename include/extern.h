...
extern int san_threshhold(void);
extern int random_frequency(void);
extern int spawn_random_monster(void);
...
extern void dochain_lashes(struct monst *);
...
extern void incarnator_spawn(xchar, xchar, boolean);

/* ### apply.c ### */

extern int doapply(void);
extern int dorub(void);
extern int doresearch(void);
...
extern int defile_count(void);
extern int preservation_count(void);
extern int vampire_count(void);
extern int rot_count(void);
extern boolean defile_ok(void);
extern boolean impurity_ok(void);
extern boolean research_incomplete(void);
extern int reanimation_count(void);
extern boolean reanimation_insight_ok(void);
extern boolean reanimation_ok(void);
...
extern boolean arti_laidtorest(struct obj *);
...
extern void set_spear_intrinsic(struct obj *,boolean,long long);
...
extern void mind_blade_conflict(struct monst *, struct monst *, int, boolean);
...
extern int throweffect(void);
extern int kinsteal_theft(struct monst *, int);
...
extern void set_silvergrubs(boolean);
extern void change_uinsight(int);
extern boolean check_insight(void);
extern int roll_impurity(boolean);
extern int roll_generic_madness(boolean);
extern int roll_generic_flat_madness(boolean);
extern int count_madnesses(void);
extern int roll_madness(long long int);
extern int mad_turn(long long int);
extern int flat_mad_turn(long long int);
extern int mad_monster_turn(struct monst *, long long int);
...
extern void doaltarobj(struct obj *, int);
...
extern void gray_moldy_corpse(void *, long);
...
extern void doliving_cricket(struct monst *);
...
extern void cyclone_slash_monsters(boolean);
...
extern int zap_sapburner(struct obj *,int, int);
...
extern boolean jumping_polearm(void *, int, int);
...
#endif
extern const char * forward_arrow(void);
extern const char * bent_arrow(void);
extern const char * up_arrow(void);
extern const char * uturn_arrow(void);
extern const char * backward_arrow(void);
...
extern void Use_crystal_lifesaving(void);
...
extern void nightmare_mold_lose_experience(void);
...
extern void explode_spell(int, int, int, int, int, int, int, long);
...
extern int smithing_bonus(void);
extern boolean have_blood_smithing_crystal(struct obj *);
extern struct obj * find_blood_smithing_crystal(struct obj *);
extern boolean have_blood_smithing_fire(struct obj *);
extern boolean have_blood_smithing_cold(struct obj *);
extern boolean have_blood_smithing_lightning(struct obj *);
extern boolean have_blood_smithing_acid(struct obj *);
extern boolean have_blood_smithing_buc(struct obj *);
extern boolean have_blood_smithing_x(struct obj *, int);
extern boolean get_blood_smithing_x(int, struct obj **, int *);
extern boolean check_undead_hunter_weapon_skills(void);
extern void expert_undead_hunter_skill(void);
...
extern void dolavademon(void);
extern void blowupforge(int, int);
...
extern boolean known_glyph(long int);
...
extern boolean is_worn_no_flags(struct obj *);
extern boolean is_worn(struct obj *, int);
...
extern struct obj *find_object_type(struct obj *, int);
extern struct obj *find_charged_object_type(struct obj *, int);
...
extern struct permonst *rndmonst(int, int);
extern int rndshape(boolean(*)(int));
extern void reset_rndmonst(int);
extern struct permonst *mkdragon(void);
...
extern boolean peace_minded(struct monst *);
...
extern int default_strongmonst_strength(int);
...
extern int xcasty(struct monst *, struct monst *, struct attack *, int, int, int);
...
extern void dream_wolves(int, int);
...
extern struct obj *duplicate_obj(struct obj *, boolean);
...
extern void mkfingervault(void);
extern void mkmivaultitem(struct obj *);
extern struct obj * mkjewel(void);
extern struct obj * mkyourblood(void);
extern struct obj * mkcolumnarcrystal(int);
...
extern void place_elfhaunt_forest_features(void);
extern void place_haunted_forest_features(void);
...
extern boolean find_artifact(struct monst *);
extern int use_artifact(struct monst *);
...
extern boolean allow_all_nomods(struct obj *);
extern boolean allow_all(struct obj *, int);
extern boolean allow_category(struct obj *, int);
extern boolean is_worn_by_type(struct obj *, int);
extern int pickup(int);
extern int pickup_object(struct obj *, long, boolean);
extern int query_category(const char *, struct obj *, int,
				menu_item **, int);
extern int query_objlist(const char *, struct obj *, int, menu_item **, int, boolean (*)(struct obj *, int));
...
extern int use_demon_claw(struct obj *);
...
extern const char *ptrbodypart(struct permonst *,int, struct monst *);
extern const char *body_part(int);
extern boolean separate_respiration(struct permonst *);
...
extern boolean make_hallucinated(long,boolean,long long);
...
extern coord * find_shrine_altar(int);
extern aligntyp temple_alignment(int);
extern int temple_god(int);
...
extern int ufire_blaster(struct obj *, int);
extern int dofire(void);
extern int uthrow(struct obj *, struct obj *, int, boolean, boolean);
extern int mthrow(struct monst *, struct obj *, struct obj *, int, int, boolean);
extern void return_ammo(void *, long);
extern int calc_multishot(struct monst *, struct obj *, struct obj *, int);
...
extern struct permonst *qt_montype(int, int);
...
extern struct permonst *moon_montype(void);
...
extern void mon_forget(struct monst *, int, boolean, boolean, boolean);
...
/* ### research.c ### */
extern int doupgradeability(void);
...
extern void smith_resizeArmor(struct monst *, struct obj *);
...
extern void unlockRoleSkill(int);
...
extern void minstapetrify(struct monst *, boolean, boolean);
...
extern int float_down(long long, long long);
...
extern void obj_extract_self_from_trap(struct obj *);
...
extern void setmwielded(struct monst *, struct obj *, long long);
...
extern unsigned long process_etraits(unsigned long, int, struct obj *, struct monst *, struct permonst *);
extern boolean check_etrait(struct obj *, struct monst *, unsigned long);
...
extern void rewield(struct obj *, long long);
...
extern void update_mon_vulnerability(struct monst *,int, boolean);
...
extern int roll_mdr_detail(struct monst *, struct monst *, int, int, uchar);
...
extern void silverman_exhultation(int);
extern boolean peace_check_move(struct monst *);
extern void rotate_plus45(int *, int *);
extern void rotate_minus45(int *, int *);
...
extern int xattacky(struct monst *, struct monst *, int, int, long);
extern int xmeleehity(struct monst *, struct monst *, struct attack *, struct obj **, int, int, boolean, long);
...
extern int xstoney(struct monst *, struct monst *, boolean);
extern int xmeleehurty(struct monst *, struct monst *, struct attack *, struct attack *, struct obj **, boolean, int, int, int, boolean);
extern int xmeleehurty_core(struct monst *, struct monst *, struct attack *, struct attack *, struct obj **, boolean, int, int, int, boolean, unsigned long);
extern void getgazeinfo(int, int, struct permonst *, struct monst *, struct monst *, boolean *, boolean *, boolean *, boolean *);
...
extern int hmon_general_modifiers(struct monst *, struct monst *, struct attack *, struct attack *, struct obj **, void *, int, int, int, boolean, int, boolean, int, unsigned long);
...
extern boolean forward_arc_monk_target(boolean);
extern void sakura_slash_monsters(void);
...
extern int uturn_move(void);
extern int alternated_move(void);
...
extern int destroy_items_sonic(struct monst *, boolean);
extern int destroy_items_liquify(struct monst *, boolean);
...
extern int hit_with_amalgamated_iwarp(struct monst *,struct obj *, int, int, int, struct attack *);
extern int hit_with_rblood(struct monst *,struct obj *, int, int, int, struct attack *);
extern int shoot_with_gun_katar(struct monst *,struct obj *, int, int, int, struct attack *);
extern int hit_with_cblood(struct monst *,struct obj *, int, int, int, struct attack *);
...
extern int mm_resist(struct monst *,struct monst *,int,int);
