...
{	{"Barbarian", 0}, {
	...
	MA_HUMAN|MA_ORC|MA_VAMPIRE|MA_DRAGON|MA_ANIMAL|MA_REPTILIAN|MA_ETHEREAL|MA_PLANT|MA_DEMIHUMAN|MA_AQUATIC, ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{  16,  7,  7, 15, 16,  6 },
	{  30,  6,  7, 20, 30,  7 },
...
{	{"Binder", 		 0}, {
	...
	ART_PEN_OF_THE_VOID,
	MA_HUMAN|MA_DWARF|MA_GNOME|MA_ELF|MA_ORC|MA_CLOCK|MA_VAMPIRE|MA_DRAGON|MA_ANIMAL|MA_FEY|MA_REPTILIAN|MA_ETHEREAL|MA_PLANT|MA_DEMIHUMAN|MA_AQUATIC, ROLE_MALE|ROLE_FEMALE |
...
{	{"Tourist", 0}, {
	...
	MA_HUMAN|MA_ETHEREAL|MA_AQUATIC, ROLE_MALE|ROLE_FEMALE | ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{   7, 10,  6,  7,  7, 10 },
	{  15, 10, 10, 15, 30, 20 },
	/* Init   Lower  Higher */
