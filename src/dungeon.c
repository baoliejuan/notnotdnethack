...
static int dname_to_dnum(const char *);
static int find_branch(const char *, struct proto_dungeon *);
static int parent_dnum(const char *, struct proto_dungeon *);
static int level_range(int,int,int,int,struct proto_dungeon *,int *);
static int parent_dlevel(const char *, struct proto_dungeon *);
...
static int pick_level(boolean *, int);
static boolean place_level(int, struct proto_dungeon *);
static boolean select_alternate(int, struct proto_dungeon *);
#ifdef WIZARD
...
static void print_mapseen(winid,mapseen *,boolean);
static boolean interest_mapseen(mapseen *);
static char *seen_string(xchar, const char *);
 ...
 */
static int
level_range(int dgn, int base, int rand, int chain, struct proto_dungeon *pd, int *adjusted_base)
{
...
boolean
select_alternate(int i, struct proto_dungeon *pd)
{
	int j;
	int altnum = 0;
	boolean select;
...
void
init_dungeons(void)		/* initialize the "dungeon" structs */
{
	dlb	*dgn_file;
...
d_level *
branchlev_other_end(branch *bptr, d_level *lev)
{
	d_level * other_end;
...
boolean
In_quest(	/* are you in the quest dungeon? */
	d_level *lev)
{
...
boolean
In_mines_quest(	/* are you in the mines, or a quest dungeon 'located' in the mines? */
	d_level *lev)
{
...
boolean
In_mines(	/* are you in the mines dungeon? */
	d_level *lev)
{
...
boolean
In_neu(	/* are you on the neutral quest? */
	d_level *lev)
{
...
boolean
In_outlands(	/* are you on the neutral quest? */
	d_level *lev)
{
...
boolean
In_lost_cities(	/* are you on the neutral quest? */
	d_level *lev)
{
...
boolean
In_cha(	/* are you on the chaotic quest? */
	d_level *lev)
{
...
boolean
In_mithardir_desert(	/* are you on the chaotic quest? */
	d_level *lev)
{
...
boolean
In_mithardir_catacombs(	/* are you on the chaotic quest? */
	d_level *lev)
{
...
boolean
In_mithardir_terminus(	/* are you on the chaotic quest? */
	d_level *lev)
{
...
boolean
In_mithardir_quest(	/* are you on the chaotic quest? */
	d_level *lev)
{
...
boolean
In_FF_quest(	/* are you on the chaotic quest? */
	d_level *lev)
{
...
boolean
In_mordor_quest(	/* are you on the chaotic quest? */
	d_level *lev)
{
...
boolean
In_mordor_forest(	/* are you on the chaotic quest? */
	d_level *lev)
{
	return((boolean)(lev->dnum == chaos_dnum && chaos_dvariant == MORDOR && (
...
boolean
In_mordor_fields(	/* are you on the chaotic quest? */
	d_level *lev)
{
	return((boolean)(lev->dnum == chaos_dnum && chaos_dvariant == MORDOR && (
...
boolean
In_mordor_buildings(	/* are you on the chaotic quest? */
	d_level *lev)
{
	return((boolean)(lev->dnum == chaos_dnum && chaos_dvariant == MORDOR && (
...
boolean
In_mordor_depths(	/* are you on the chaotic quest? */
	d_level *lev)
{
	return((boolean)(lev->dnum == chaos_dnum && chaos_dvariant == MORDOR && (
...
boolean
In_mordor_borehole(	/* are you on the chaotic quest? */
	d_level *lev)
{
	return((boolean)(lev->dnum == chaos_dnum && chaos_dvariant == MORDOR && (
...
boolean
In_law(	/* are you on the lawful quest? */
	d_level *lev)
{
...
boolean
In_paths_of_law(	/* In the paths of law region? */
	d_level *lev)
{
	return((boolean)(lev->dnum == law_dnum));
}
...
static void
print_branch(winid win, int dnum, int lower_bound, int upper_bound, boolean bymenu, struct lchoice *lchoices)
{
    branch *br;
    char buf[BUFSZ];
    anything any;
...
static void
print_mapseen(winid win, mapseen *mptr, boolean printdun)
{
	char buf[BUFSZ];
	int i, depthstart;
