...
static void
kick_monster(register xchar x, register xchar y)
{
...
void
dive_kick_monster(struct monst *mon)
{
	int i = -inv_weight();
	int j = weight_cap();
...
void
impact_drop(struct obj *missile, xchar x, xchar y, xchar dlev, boolean yourfault)
{
	schar toloc;
