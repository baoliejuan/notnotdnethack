...
void
add_altar(int x, int y, aligntyp alignment, boolean shrine, int godnum)
{
...
boolean
mkfeature(int typ, int mazeflag, struct mkroom *croom)
{
	coord m;
	int tryct = 0;
	int tmp = 0;
...
void
mkHVstatue(int x, int y, int hv_id)
{
	int mid = PM_LAMB;
	struct obj* obj;
	switch(hv_id){
