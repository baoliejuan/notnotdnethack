...
CLOAK(("cloak of invisibility", "opera cloak"),
		0, 1,   9, 0, 10, 60,  9, 0, 2, CLOTH, CLR_BLACK, O_POWER(INVIS)),
CLOAK(("cloak of magic resistance", "ornamental cope"),
		0, 1,	2, 0, 10, 60, 10, 0, 3, CLOTH, CLR_WHITE, O_POWER(ANTIMAGIC)),
CLOAK(("cloak of flight", "feathery cloak"),
		0, 1,   2, 0, 10, 60, 10, 0, 3, CLOTH, CLR_BRIGHT_CYAN, O_POWER(FLYING)),
CLOAK(("cloak of displacement", "piece of cloth"),
		0, 1,   9, 0, 10, 50,  9, 0, 2, CLOTH, CLR_BRIGHT_MAGENTA, O_POWER(DISPLACED)),
